  ...
  return (
    <>
      ...
      <main style={{ padding: "2rem", fontFamily: "sans-serif", background: "#fff8f0" }}>
        ...
        >
          <img src={tucano} alt="Tucano Toco" width="170" style={{ border: '4px solid #f39912', borderRadius: 12, objectFit: 'cover', height: 140 }} />
          <img src={teucaninho032} alt="Tucaninho" width="170" style={{ border: '4px solid #f39912', borderRadius: 12, objectFit: 'cover', height: 140 }} />
          <img src={mastigano} alt="Tucano mastigando" width="170" style={{ border: '4px solid #f39912', borderRadius: 12, objectFit: 'cover', height: 140 }} />
          <img src={tucano01} alt="Tucano 01" width="170" style={{ border: '4px solid #f39912', borderRadius: 12, objectFit: 'cover', height: 140 }} />
          <img src={tucano02} alt="Tucano 02" width="170" style={{ border: '4px solid #f39912', borderRadius: 12, objectFit: 'cover', height: 140 }} />
          <img src={tucanotuco04} alt="Tucano Tuco 04" width="170" style={{ border: '4px solid #f39912', borderRadius: 12, objectFit: 'cover', height: 140 }} />
          <img src={dancingTeucano} alt="Tucano dançando" width="170" style={{ border: '4px solid #f39912', borderRadius: 12, objectFit: 'cover', height: 140 }} />
          <img src={tucanocu} alt="Tucanocu" width="170" style={{ border: '4px solid #f39912', borderRadius: 12, objectFit: 'cover', height: 140 }} />
        </section>
